...
# Summon items
execute if score iron result matches 0 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop0","drop","0"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:speed",amplifier:1,duration:400}],CustomPotionColor:10806260}}],Invisible:1}
execute if score iron result matches 1 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop1","drop","0"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:jump_boost",amplifier:4,duration:400}],CustomPotionColor:1309504}}],Invisible:1}
execute if score iron result matches 2 run summon minecraft:armor_stand ~ ~ ~ {Tags:["cleanup","sparkling","drop2","drop","0"],Marker:1b,ArmorItems:[{},{},{},{id:"minecraft:potion",Count:1b,tag:{custom_potion_effects:[{id:"minecraft:slow_falling",duration:400}],CustomPotionColor:16777215}}],Invisible:1}