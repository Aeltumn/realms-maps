...
execute as @a[tag=armor1selected] if entity @s[nbt=!{Inventory:[{Slot:100b,id:"minecraft:leather_boots"}]}] run item replace entity @s armor.feet with minecraft:leather_boots[minecraft:dyed_color=1184274]
